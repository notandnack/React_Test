            ...
            <div className="row">
              ...
              <div className="col-lg-9">
                ...
                <div className="boxwhiteShadow">
                                    ...
                                    <div className="Cropscroll">
                                        <div className="promo_slide select-display-slide mt-4">
                                            <li className="active" rel="1">
                                                <a href="#">Code From Word Why Weed</a>
                                            </li><li rel="2">
                                                <a href="#">
                                                    Code From Partner
                                                </a>
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="display-slide mt-4" rel="1" style={{ display:"none" }}>
                                        <div className="row">
                                            {/* <?php for ($i = 1; $i <= 6; $i++) { ?> */}
                                                        ...
                                                        <div className="col-lg-8">
                                                            <div className="row">
                                                                <div className="col-lg-7">
                                                                    <div className="code_detail pt-2 pl-3 pb-2 pr-2">
                                                                        50% off <br/>
                                                                        Min. Spend ฿฿499

                                                                        <span className="smtxt">Valid Till : <br/>
                                                                ...
                                                                <div className="col-lg-5">
                                                                    <a href="#" className="btn btn-info">Use code</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
